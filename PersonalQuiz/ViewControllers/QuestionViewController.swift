...
final class QuestionViewController: UIViewController {
    ...
    // Передаем информацию на экран ResultViewController
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        guard let resultQC = segue.destination as? ResultViewController else { return }
        resultQC.answersChosen = answersChosen
    }
